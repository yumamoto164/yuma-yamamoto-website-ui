...
export function MainPage() {
  return (
    <section
      id="home"
      className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 pt-16"
    >
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-8 items-start mb-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-400 dark:text-gray-400 mt-1">
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-sm font-semibold tracking-widest text-gray-400 dark:text-gray-400 uppercase mb-4">
              Skills
            </h3>
            <SkillsGrid />
          </div>
